...
namespace AzureBookManagement.Controllers
{
    public class BookCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Category")] BookCategory bookCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Category")] BookCategory bookCategory)
        {
            if (id != bookCategory.Category)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!BookCategoryExists(bookCategory.Category))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.BookCategories?.Any(e => e.Category == id)).GetValueOrDefault();
        }
    }
}
